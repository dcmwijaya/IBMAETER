    ...
    <div class="row">
        ...
        <div class="col-sm-4 border-left">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control mb-2" id="password" placeholder="Tuliskan Password User..." name="password" required autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control mb-2" id="password2" placeholder="konfirmasi Password User..." name="confirm_password" required autocomplete="off">
        ...
        <div class="col-sm-4 border-left">
            ...
            <div class="form-group">
                ...
                <select class="form-control mb-2" id="jenis_user" name="role">
            ...
            <div class="form-group">
                ...
                <select class="form-control mb-2" id="division" name="division" disabled="disabled">
                </select>
