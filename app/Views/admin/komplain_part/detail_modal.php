...
<div class="modal-body row">
    ...
    <div class="col-sm-6 px-4">
        <div class="form-group">
            <i class="fas fa-fw fa-file-archive" style="color:#ff7500;"></i> <small>Berikut detail keluhan yang diajukan oleh pekerja</small>
            <hr class="mt-0 mb-2">
    ...
    <div class="col-sm-6 pt-1 border-left">
        ...
        <div class="form-group">
            ...
            <textarea rows="6" class="col-sm-12 p-2 <?= ($validation->hasError('adminkomen_komplain')) ? 'is-invalid' : ''; ?>" id="acc_komentar" name="adminkomen_komplain" placeholder="Tuliskan Komentar Anda bila perlu" value="<?= (old('adminkomen_komplain')) ? old('adminkomen_komplain') : ""; ?>" readonly></textarea>
