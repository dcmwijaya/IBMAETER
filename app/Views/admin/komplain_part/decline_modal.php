...
<div class="modal-body row">
    ...
    <div class="col-sm-6 px-4">
        <div class="form-group">
            <i class="fas fa-fw fa-paperclip" style="color:red;"></i> <small>Berikut detail keluhan yang diajukan oleh pekerja</small>
            <hr class="mt-0 mb-2">
    ...
    <div class="col-sm-6 pt-1 border-left">
        <div class="form-group row">
            <h5><i class="fas fa-fw fa-pen-square" style="color:red;"></i> Tolak Data Keluhan Pekerja</h5>
        </div>
        <hr class="mt-0 mb-2">
        <div class="form-group">
...
<div class="modal-footer">
    ...
    <input type="hidden" id="dec-status" name="status" value="rejected">
