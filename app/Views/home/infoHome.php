		...
		<section class="article">
				...
				<div class="row no-gutters info-wrap">
					...
					<div class="col-md-7">
						<div class="card-body event-description">
							...
							<p class="card-text col-md-12">Berdasarkan laporan bulanan dapat disimpulkan hingga tahun 2021 ini, Ibmaeter sudah sangat membantu dalam bisnis.</p>
			...
			<div class="info-card card mb-3 bg-light">
				<div class="row no-gutters info-wrap">
					...
					<div class="col-md-7">
						<div class="card-body event-description">
							<h5 class="card-title"><i class="fas fa-business-time fa-fw me-2"></i>Partnership Pada Tahun 2021</h5>
							<p class="card-text"><small class="text-muted"><i class="fas fa-calendar fa-fw me-2"></i>20-02-2021 | 08:15 AM</small></p>
							<p class="card-text col-md-12">Partnership kami dengan perusahaan yang ada di Indonesia dalam kegiatan suplai dan inventaris barang.</p>
							<button class="btn btn-primary" type="button">
								<span>Read More</span>
							</button>
						</div>
				...
				<div class="row no-gutters info-wrap">
					...
					<div class="col-md-7">
						<div class="card-body event-description">
							...
							<p class="card-text col-md-12">Agenda tahunan kami di tahun 2021 ini berupa perencanaan kerjasama dengan beberapa supplier besar yang ada di Indonesia.</p>
							<button class="btn btn-primary" type="button">
								<span>Read More</span>
							</button>
						</div>
