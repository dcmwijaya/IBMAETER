...
<div class="modal-body">
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="requeststok text-center">
                                <span class="py-2 badge badge-success" style="font-size: 16px;"><i class="fas fa-fw fa-long-arrow-alt-up text-light"></i> Masuk</span>
                            </div>
                        </div>
                        <div class="col-sm-6">
        ...
        <div class="col-sm-6 border-left">
            <div class="form-group">
                <label for="InTime" class="font-weight-bold"><i class="fas fa-fw fa-calendar-alt"></i> Date and time</label>
                <input type="datetime-local" class="form-control" value="" id="InTime" name="tgl" required>
            </div>
            <div class="form-group">
                <label for="InInfo"><b><i class="fas fa-fw fa-comment-dots"></i> Keterangan</b></label>
                <textarea class="form-control" id="InInfo" rows="6" name="ket" placeholder="Sampaikan isi Keterangan...&#10;" required></textarea>
