...
<body>
				...
				<div class="card" style="margin-top: 58px">
					<div class="card-header text-center py-3">
						<h3 class="mb-0 text-center">
							<center><strong>Tabel Manajemen Barang Gudang 2021</strong></center>
						</h3>
					</div>
					<div class="card-body">
						<div class="row">
	...
	<script>
		window.print(); window.onafterprint = function() { window.location.href = "<?= base_url('menu/kelolaBarang') ?>"; }
	</script>
</body>
