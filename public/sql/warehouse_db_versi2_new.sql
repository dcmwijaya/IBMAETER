...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Bulan Mei 2021 pada 19.53
...
(5, 30, 'erwin1@gmail.com', 'Late', '2021-05-17', '11:23:04'),
(6, 69, 'tesla@gmail.com', 'Late', '2021-05-18', '10:01:59');
...
(1, 'INFO FOUNDER', 'BESOK RAPAT BULANAN, harap hadir tepat waktu seperti biasa. Sekian dari saya terima kasih.', 'image.jpg');
...
(69, 'Alfha Fierly Firdaus', 'alfhaff@invenbar.ac.id', '$2y$10$YzNdlTgkVRTdLwLeTTk3UeJLSq49oLl/TV8n5aan5sS.WOCPNqXHC', 0, 'alfha.jpg', 'Founder/Ceo/Direktur', 'Male'),
(73, 'Tasya Anastasya Mufida', 'tasyamufida@gmail.com', '$2y$10$OmObGK88s66R91.L6iP0..HkpTROR/T1oWUGbOHxA/KUN2gKvmiU.', 0, 'default.jpg', 'Founder/Ceo/Direktur', 'Female');
...
--
ALTER TABLE `absensi`
  MODIFY `id_absen` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
